            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box box-info">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form:form id="inputForm" cssClass="form-horizontal" action="/contect/category/save" method="post" modelAttribute="tbContentCategory">
                            <form:hidden path="id"/>
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="parentId" class="col-sm-2 control-label">父级类目</label>
                                    <div class="col-sm-10">
                                       <%-- <form:hidden path="parentId" name="parentCategory.id"/>--%>
                                        <input id="parentId" name="parentCategory.id" value="${tbContentCategory.parentCategory.id}" type="hidden"/>
                                        <input id="parentName" class="form-control required" placeholder="请选择" readonly="true" onclick="showChoise();" value="${tbContentCategory.parentCategory.name}"/>
                                    </div>
                                </div>
                                <div class="form-group">
