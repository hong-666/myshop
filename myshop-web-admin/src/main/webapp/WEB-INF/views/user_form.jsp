                           ...
                           <form:hidden path="id"/>
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:password cssClass="form-control required" path="password" placeholder="请输入登陆密码"/>
                                       <%-- <input type="password" class="form-control" id="inputPassword3" name="password" placeholder="请输入登陆密码">--%>
                                    </div>
                                </div>
                                <div class="form-group">
